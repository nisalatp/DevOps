...
| 11 — API wait | Waits for the API server to finish processing Calico resources (prevents rate-limit timeout) |
| 12 — Join commands | Extracts join commands from the init output and copies PKI certs to `/vagrant/pki/` |
